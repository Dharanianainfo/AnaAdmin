    ...
    return (
      <nav className="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <Link className="navbar-brand brand-logo" to="/"><img src={require('../../assets/images/analogo.png')} alt="logo" /></Link>
          <Link className="navbar-brand brand-logo-mini" to="/"><img src={require('../../assets/images/analogo.png')} alt="logo" /></Link>
        </div>
        <div className="navbar-menu-wrapper d-flex align-items-stretch">
          ...
          <ul className="navbar-nav navbar-nav-right">
            <li className="nav-item nav-profile">
              <Dropdown alignRight onClick={this.profile}>
                <Dropdown.Toggle className="nav-link">
                  ...
                  <div className="nav-profile-text">
                    <p className="mb-1 text-black"><Trans><b>ANA INFO</b></Trans></p>
                  </div>
                </Dropdown.Toggle>
                ...
                <Dropdown.Item href="#" onClick={evt =>evt.preventDefault()}>
                    ...
                    <Trans> <button style={{"border":"none","backgroundColor":"white"}}>
                    <Link className="navbar-brand brand-logo" to={"/"}>Profile</Link>
                    </button></Trans>
                  </Dropdown.Item>        
                  <Dropdown.Item  href="#" onClick={evt =>evt.preventDefault()}>
                    <i className="mdi mdi-logout mr-2 text-primary"></i>
                    <Trans> <button style={{"border":"none","backgroundColor":"white"}} onClick={this.logout}>
                    <Link className="navbar-brand brand-logo" to={"/"}>Signout</Link>
                    </button></Trans>
                  </Dropdown.Item>
                </Dropdown.Menu> */}
              </Dropdown>
            ...
            <li className="nav-item">
             ...
             {/* <li className="nav-item nav-profile d-none d-lg-block text-primary">
              <a className="nav-link" href="/admindetails" >
                <i title="Profile" className="mdi mdi-account "></i>
              </a>
            </li> */}
            <li className="nav-item nav-logout d-none d-lg-block text-primary">
              <a className="nav-link" href="/" onClick={this.logout}>
                <i title="logout" className="mdi mdi-power"></i>
              </a>
            </li>
            <li className="nav-item nav-settings d-none d-lg-block text-primary">
