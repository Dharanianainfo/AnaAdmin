...
export default function Bitzfunshow(){
              ...
              <div className="card-body">
                ...
                <Table className='table table-striped'>
                    ...
                    {foundUsers.length > 0 ?(foundUsers.map((user) => (
                            <tr key={user.id}>
                                {/* <td>{user.id}</td>  */}
                               <td>{ user.violationFlag? <i className='mdi mdi-checkbox-blank-circle' id="flag"></i>: 
                                <i className='mdi mdi-checkbox-blank-circle' id="unflag"></i>}</td> 
                                <td>  {user.Idcard}</td>
                                <td>{user.username}</td>
                                <td>{user.RollNo}</td>
                                <td>{user.phoneNo}</td>
                                <td>{user.violationFlag.toString()}</td>
                                <td><Badge bg='primary'>unflag</Badge></td>
                                <td>
